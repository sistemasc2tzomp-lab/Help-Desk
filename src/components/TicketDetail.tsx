  ...
  return (
    <div className="p-6 sm:p-10 max-w-6xl mx-auto space-y-8 bg-[#030014] min-h-screen">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => { const doc = new jsPDF(); generateProfessionalTicketReport(doc, ticket, dept); }} className="flex items-center gap-3 bg-white/5 hover:bg-white/10 text-white border border-white/10 px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[3px] transition-all">
